      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            //                 Text(tag.name,
            //                     style: TextStyle(
            //                         color: AppColors.base100, fontSize: 12)),
            //                 Container(
            //                   width: 2,
            //                 ),
            //               ],
            ...
            //       //   //           ),
            //       //   //           Icon(Icons.edit,
            //       //   //               color: AppColors.base100, size: 12)
            //       //   //         ],
            //       //   //       ),
            //       //   //     ),
            //       //   //   ),
            ...
            Builder(builder: (BuildContext context) {
              if (_objectType == 'pengeluaranKategori' ||
                  _objectType == 'pemasukanKategori') {
                ...
                return Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      isDense: true,
                      hintStyle:
                          TextStyle(color: AppColors.base300, fontSize: 14),
                      hintText: "Notes...",
                    ),
                  ),
                );
